...
| :--- | :--- | :---: | :--- | :--- |
| **Windows MSI Installer** | Windows 10 / 11 | `x64` | [**📥 OpenRFID_Simulator_v1.0.0_x64.msi**](https://github.com/rfidsoftwares/openrfid-simulator/releases/latest/download/OpenRFID_Simulator_v1.0.0_x64_en-US.msi) | Standard Windows Installer package. Self-registers background services. |
| **Windows EXE Setup** | Windows 10 / 11 | `x64` | [**📥 OpenRFID_Simulator_v1.0.0_x64_Setup.exe**](https://github.com/rfidsoftwares/openrfid-simulator/releases/latest/download/OpenRFID_Simulator_v1.0.0_x64-setup.exe) | Portable setup wizard with custom install path options. |
